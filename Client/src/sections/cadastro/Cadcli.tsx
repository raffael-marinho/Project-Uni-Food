                        ...
                        {({ isSubmitting, setFieldValue }) => (
                            <Form className="flex flex-col">
                                ...
                                <div className="flex flex-col mb-2">
                                    <div className="relative">
                                        ...
                                        <div className="flex items-center border-2 border-[#CE9E7E] p-2 rounded-sm w-[300px] bg-transparent text-foreground focus-within:border-foreground focus-within:outline-none">
                                            ...
                                            <Field
                                                ...
                                                maxLength={9}
                                                className="flex-1 bg-transparent outline-none placeholder-[#CE9E7E] text-foreground"
                                    ...
                                    <ErrorMessage name="telefone" component="div" className="text-primary text-sm flex flex-col" />
                                </div>
