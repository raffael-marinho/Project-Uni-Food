...
const CardPedidoVendas: React.FC<CardPedidoVendasProps> = ({ nome, code, confirmado }) => {
  return (
    <div className="w-full h-[108px] flex-shrink-0 bg-[#FFF6E0] rounded-lg flex items-center shadow-md overflow-hidden border border-[#E5C690]">
      
      {/* Nome do Cliente */}
      <div className="flex-1 px-4 text-brown-800 font-semibold text-lg">
        {nome}
      </div>
